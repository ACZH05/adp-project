# Refined System Requirements (v2)

## Changelog from v1

- Added BullMQ + Redis async verification queue between S2 and S3
- Updated INT-01 to describe job payload over queue instead of direct HTTP handoff
- Added INT-12 and INT-13 for queue job lifecycle events
- Added S3-M4: Queue Infrastructure and Worker Management (new module)
- Updated S2-FR-03, S2-FR-10, S3-FR-07, S3-NFR-01 to reflect async flow
- Added storage requirements under S2-M1 using Supabase Storage
- Updated team ownership to reflect queue responsibilities
...
#### Module S3-M4: Queue Infrastructure and Worker Management _(new)_
...
- `VerificationJobPayload` _(updated)_
...
- `INT-01` | Type: `INT` | Module: `Queue S2 -> S3` _(updated)_
...
- `INT-12` | Type: `INT` | Module: `Queue event S3 -> S2` _(new)_
...
- `INT-13` | Type: `INT` | Module: `Queue event S3 -> S4` _(new)_
...
- **Member 1**
  ...
  Dependencies/Handoffs: Provides centralized auth validation interfaces for S2, S3, and S4 (`INT-06` through `INT-11`); provides RBAC and audit foundation to all subsystems.
...
- **Member 2**
  ...
  Dependencies/Handoffs: Requests and consumes auth from S1 (`INT-06`, `INT-07`); pushes to queue (`INT-01`); consumes verification and decision outputs from S3/S4 (`INT-02`, `INT-04`, `INT-12`).
...
- **Member 4**
  ...
  Dependencies/Handoffs: Requests and consumes auth from S1 (`INT-10`, `INT-11`); consumes verification output from S3; sends decision records to S2; aggregates KPI events from S2/S3/S4 (`INT-04`, `INT-05`, `INT-13`).
...
- **O1: Online platform with AI pre-verification**
  ...
  Primary Requirement Coverage: `S1-FR-07`, `S2-FR-01`, `S2-FR-03`, `S2-FR-04a`, `S2-FR-12`, `S3-FR-01`, `S3-FR-04`, `S3-FR-08`, `S3-FR-09`, `S4-FR-01`, `INT-01`, `INT-03`, `INT-06`, `INT-07`, `INT-08`, `INT-09`, `INT-12`
...
- **O3: Reduce processing time within 6 months**
  Measurable Target: Cycle-time trend (including queue wait time) decreases from baseline within 6 months after implementation.
  Primary Requirement Coverage: `S1-FR-06`, `S1-FR-07`, `S1-FR-08`, `S2-FR-04a`, `S2-FR-10`, `S2-FR-12`, `S3-FR-06`, `S3-FR-07`, `S3-FR-08`, `S3-FR-09`, `S3-FR-10`, `S3-FR-11`, `S3-FR-12`, `S3-NFR-01`, `S3-NFR-05`, `S4-FR-01`, `S4-FR-02`, `S4-FR-08`, `S4-FR-11`, `S4-FR-12`, `S4-NFR-03`, `INT-04`, `INT-05`, `INT-06`, `INT-07`, `INT-08`, `INT-09`, `INT-10`, `INT-11`, `INT-12`, `INT-13`
