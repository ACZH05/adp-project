...
interface UserApplication {
  ...
  status: 'Pending' | 'AI-Ready' | 'Flagged' | 'Processed' | 'Rejected' | 'Draft';
  aiConfidence: number;
  documents: {
    total: number;
    approved: number;
...
export default function ApplicationsPage() {
  ...
  const processedApplications = useMemo(() => {
    let result = [...mockUserApplications];

    // 1. Filter by Search Query (ID or License Type)
    if (searchQuery.trim()) {
  ...
  // Helper to determine AI Confidence text color and bar color
            ...
            return (
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                  ...
                  {/* Middle Column: AI Confidence Metric */}
                  ...
                  <div className="flex items-center justify-start lg:justify-end shrink-0 w-full lg:w-36">
                    {app.status === 'Draft' ? (
                      <Button
                        onClick={() => router.push('/applicant/apply/1')}
          ...
          <Card className="border border-border-muted p-12 bg-white text-center flex flex-col items-center justify-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted mt-1 max-w-sm mx-auto leading-relaxed">
                We couldn't find any applications matching your current filter criteria. Try clearing search keywords or selecting a different status.
              </p>
            </div>
